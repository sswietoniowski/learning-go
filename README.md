...
- frameworks & libraries:
  ...
  - network services:
    ...
    - [protobuf-go](https://github.com/protocolbuffers/protobuf-go) - a Go support for Google's protocol buffers,
    - [grpc-go](https://github.com/grpc/grpc-go) - a Go implementation of gRPC,
